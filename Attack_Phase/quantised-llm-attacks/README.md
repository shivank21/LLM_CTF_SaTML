...
This is a version of LLM-Attacks code that supports GPTQ quantized models using AutoGPTQ and is only works for quantised models.
For non-quantised attacks and reproduction of [paper](https://arxiv.org/pdf/2307.15043.pdf) results refer to [LLM Attacks](https://github.com/llm-attacks/llm-attacks)
...
Check out the [website and demo here](https://llm-attacks.org/).

## Updates
- (2023-08-16) The authors include a notebook `demo.ipynb` (or see it on [Colab](https://colab.research.google.com/drive/1dinZSyP1E4KokSLPcCh1JQFUFsN-WV--?usp=sharing)) containing the minimal implementation of GCG for jailbreaking LLaMA-2 for generating harmful completion to run it on AutoGPTQ just clone our repo instead of the [llm-attacks repo](https://github.com/llm-attacks/llm-attacks).
